...
public class Controller {
    ...
    public void initialize() {
        ...
        pane1.setStyle("-fx-background-image: url('img/pic1.jpg')");
        pane2.setStyle("-fx-background-image: url('img/pic2.jpg')");
        pane3.setStyle("-fx-background-image: url('img/pic3.jpg')");
        pane4.setStyle("-fx-background-image: url('img/pic4.jpg')");

        Animation();

        hambMenu.setOnMouseClicked(event -> {
